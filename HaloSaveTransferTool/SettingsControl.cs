...
namespace HaloSaveTransferTool
{
    public partial class SettingsControl : UserControl
    {
        ...
        {
            InitializeComponent();
            SettingsGrid.Rows.Add("Built in", "A", "M" , "Help" , Properties.Settings.Default.BuiltInLocation);
            SettingsGrid.Rows.Add("Private", "A" , "M" , "Help" , Properties.Settings.Default.PrivateLocation);
            SettingsGrid.Rows.Add("Other", "A" , "M" , "Help" , Properties.Settings.Default.DefaultOtherLocation);
        }
